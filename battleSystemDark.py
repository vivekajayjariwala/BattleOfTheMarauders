...
def battleSystemDarkPage(givenName, startingPoints, newPower, newHealth):
    ...
    #load background
    background_img = pygame.image.load("assets/scene/scene_12_modified.png").convert_alpha()
    ...
    victory_img = pygame.image.load("assets/you_win_screen.jpg").convert_alpha()
    victory_rect = victory_img.get_rect()  # get coordinates
    ...
    enemy1 = Character(560, 264, 'dark', 35, 16, 0.2, 0)
