...
def battleSystemEyePage(givenName, startingPoints, newPower):

    setLvl4Character(givenName)
    ...
    #load background
    background_img = pygame.image.load("assets/scene/scene_10_modified.png").convert_alpha()
    ...
    enemy1 = Character(500, 303, 'eye', 20, 3, 0.2, 0)
    enemy2 = Character(700, 303, 'eye', 20, 3, 0.2, 0)
