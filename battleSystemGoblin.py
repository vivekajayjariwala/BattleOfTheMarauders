...
def battleSystemGoblinPage(givenName, startingPoints, newPower):

    setLvl3Character(givenName)
    ...
    #load background
    background_img = pygame.image.load("assets/scene/scene_9_modified.png").convert_alpha()
    ...
    enemy1 = Character(500, 303, 'goblin', 20, 3, 0.2, 0)
    enemy2 = Character(700, 303, 'goblin', 20, 3, 0.2, 0)
