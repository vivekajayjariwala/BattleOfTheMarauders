...
def upgradePower(power):
    global newStrength
    newStrength = power
    
def upgradeHealth(healthAmount):
    global newHealth
    newHealth = healthAmount

def battleSystemMartialPage(givenName, startingPoints, newPower):

    setLvl6Character(givenName)
    ...
    #load background
    background_img = pygame.image.load("assets/scene/scene_5_modified.png").convert_alpha()
    ...
    if givenName == "Knight":
        hero = Character(200, 306, givenName, 30 + newHealth, newPower + newStrength, 0.25, startingPoints)
    elif givenName == "Archer":
        hero = Character(200, 306, givenName, 30 + newHealth, newPower + newStrength, 0.25, startingPoints)
    elif givenName == "Wizard":
        hero = Character(200, 295, givenName, 30 + newHealth, newPower + newStrength, 0.13, startingPoints)

    enemy1 = Character(560, 303, 'martial', 30, 13, 0.2, 0)
