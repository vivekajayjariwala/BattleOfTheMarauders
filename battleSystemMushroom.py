...
import os
import random
from levelFive import *
from shoppractice import *
...
def battleSystemMushroomPage(givenName, startingPoints, newPower):

    setLvl5Character(givenName)
    ...
    #load background
    background_img = pygame.image.load("assets/scene/scene_7_modified.png").convert_alpha()
    ...
    def draw_panel():
        ...
        for count, i in enumerate(enemy_list):
            #show name and health
                draw_text(f'{i.name.capitalize()} HP: {i.health}', font, white, 430, (470) + count * 55)
    ...
    if givenName == "Knight":
        hero = Character(200, 306, givenName, 30, newPower, 0.25, startingPoints)
    elif givenName == "Archer":
        hero = Character(200, 306, givenName, 30, newPower, 0.25, startingPoints)
    elif givenName == "Wizard":
        hero = Character(200, 295, givenName, 30, newPower, 0.13, startingPoints)

    enemy1 = Character(500, 303, 'mushroom', 20, 5, 0.2, 0)
    enemy2 = Character(700, 303, 'mushroom', 20, 5, 0.2, 0)

    invisible_enemy_1 = Invisible(500, 303, 0.2)
    invisible_enemy_2 = Invisible(700, 303, 0.2)

    invisible_enemy_list = []
    invisible_enemy_list.append(invisible_enemy_1)
    invisible_enemy_list.append(invisible_enemy_2)
    ...
    enemy2_health_bar = HealthBar(430, 555, enemy2.health, enemy2.max_health)
    ...
    while running:
        ...
        enemy2_health_bar.draw(enemy2.health, red, dark_red)
        ...
        if end_game_signal != 0:
            if end_game_signal == 1:
                ...
                getPoints(hero.points,hero.power + 1)
