...
from battleSystemGoblin import battleSystemGoblinPage
...
def battleSystemSkeletonPage(givenName, startingPoints):

    setLvl2Character(givenName)
    ...
    #load background
    background_img = pygame.image.load("assets/scene/scene_6_modified.png").convert_alpha()
    ...
    if givenName == "Knight":
        hero = Character(200, 306, givenName, 30, 8, 0.25, startingPoints)
    elif givenName == "Archer":
        hero = Character(200, 306, givenName, 30, 8, 0.25, startingPoints)
    elif givenName == "Wizard":
        hero = Character(200, 295, givenName, 30, 8, 0.13, startingPoints)

    enemy1 = Character(500, 303, 'skeleton', 20, 2, 0.2, 0)
    enemy2 = Character(700, 303, 'skeleton', 20, 2, 0.2, 0)
