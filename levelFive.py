...
from battleSystemMartial import *
...
def handle_move(player, objects):
    ...
    for obj in to_check:
        if obj and obj.name == "sword":
            player.make_hit()
            battleSystemMartialPage(actor,score + 20,strength)



def main(window):
    clock = pygame.time.Clock()
    background, bg_image = get_background("level_5.png")
