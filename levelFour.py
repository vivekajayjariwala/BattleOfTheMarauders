...
def handle_move(player, objects):
    ...
    for obj in to_check:
        if obj and obj.name == "sword":
            player.make_hit()
            battleSystemMushroomPage(actor,score + 20,strength)



def main(window):
    clock = pygame.time.Clock()
    background, bg_image = get_background("level_4.png")
    ...
    objects = [
        ...
        Block(block_size * 1, HEIGHT - block_size * 3, block_size), #Player Lands
